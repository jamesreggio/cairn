...
function mergeInline(result, inline) {
  ...
  if (inline != null && typeof inline === 'object') {
    ...
    var props = inline.props;

    var rest = _objectWithoutProperties(inline, ['style', 'props']);
    ...
    if (props) {
      return _extends({}, result, props, {
        style: [].concat(_toConsumableArray(result.style), [rest])
      });
    }
  }
